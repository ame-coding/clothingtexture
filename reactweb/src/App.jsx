  ...
  return (
    <div className="app-container">
      <div className="main-card">
        <h1 className="title">Texture Clothing GAN</h1>

        {/* IMAGE */}

        <div className="section">
          <label className="label">Upload Texture Image</label>
        ...
        <div className="section">
          <label className="label">Select Clothing Class</label>
        ...
        {serverResponse && (
          <div className="response-container">
            <h2 className="response-title">Generated Result</h2>
            ...
            <div className="info-grid">
              <div className="info-card">
                ...
                <div className="info-value">{serverResponse.status}</div>
              </div>
              ...
              <div className="info-card">
                <div className="info-title">Selected Class</div>
                <div className="info-value">
              ...
              <div className="info-card">
                <div className="info-title">Source Garment</div>
                <div className="info-value">
                  {serverResponse.source_garment}
                </div>
              </div>

              <div className="info-card">
                <div className="info-title">Uploaded Texture</div>
                <div className="info-value">
              ...
              <div className="info-card">
                ...
                <div className="info-value">
                  {serverResponse.performance.processing_time_seconds} seconds
                </div>
              </div>
            </div>
          </div>
